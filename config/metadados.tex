...
\titulo{Rexton-OS - Gerenciamento de Ordem de Serviços}

\autor{Luis Gustavo Gois Chiquitin}
\local{Naviraí}
\data{2023}

%% "M\textsuperscript{e}." = Abreviação oficial para "Mestre"
\orientador{Prof. M\textsuperscript{e}. ALISSON GASPAR CHIQUITTO}
...
\preambulo{Trabalho de conclusão de curso apresentado a banca examinadora como requisito do Curso Superior de Tecnologia em Análise e Desenvolvimento de Sistemas do Instituto Federal de Educação, Ciência e Tecnologia do Mato Grosso do Sul.}
